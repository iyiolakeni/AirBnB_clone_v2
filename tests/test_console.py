...
class TestHBNBCommand(unittest.TestCase):
    ...
    def setUp(self):
        ...
        HBNBCommand._HBNBCommand__objects = {}
    ...
    def test_docstrings(self):
        ...
        methods = [method for method in dir(HBNBCommand) if callable(getattr(HBNBCommand, method))]
    ...
    @unittest.skipIf(type(HBNBCommand._HBNBCommand__storage) == DBStorage, "Testing DBStorage")
